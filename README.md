...
## 安全性への最優先事項
*   **近接停止:** ロボット稼働中にここちゃんが1.0m以内に接近した場合、1秒以内に強制停止。
...
### Cocoba ロボット本体
![Hardware Prototype](docs/99_OTHER/images/device-mockup.png)
*ルンバをベースとした移動機構に、ドーム（シールド）を投下するためのカスタムアームを搭載。AI追跡用のArUcoマーカーを備え、自律的な排泄物隔離を実現します。*

### システム・モニタリング画面 (Web UI)
![System Monitoring UI](docs/99_OTHER/images/screen-mockup.jpeg)
